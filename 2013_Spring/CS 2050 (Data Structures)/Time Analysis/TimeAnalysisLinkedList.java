...
public class TimeAnalysisLinkedList
{
	...
	public static void main(String[] args)
	{
		for(int i = 0; i <= 10; i++)
		{
			System.out.printf("%d: LinkedList Timing: (in seconds) [data size: %d]\n\n", i, buildNum);
			LinkedList<Integer> list = new LinkedList<Integer>(); //The list
	...
	public static LinkedList<Integer> build()
	{
	...
	public static void highLowGet(LinkedList<Integer> a)
	{
	...
	public static void lowHighGet(LinkedList<Integer> a)
	{
		for(int i = 0; i < buildNum; i++)
		{
			@SuppressWarnings("unused")
	...
	public static void highLowRemove(LinkedList<Integer> a)
	{
		for(int i = buildNum-1; i >= 0; i--)
		{
			a.remove(i);
	...
	public static void lowHighRemove(LinkedList<Integer> a)
	{
		for(int i = 0; i < buildNum; i++)
		{
			a.remove(0);
	...
	public static void addAtFront(LinkedList<Integer> a)
	{
		for(int i = 0; i <= buildNum; i++)
		{
	...
	public static void addAtEnd(LinkedList<Integer> a)
	{
		for(int i = 0; i <= buildNum; i++)
		{
	...
	public static void addAtRandom(LinkedList<Integer> a)
	{
		for(int i = 0; i <= buildNum; i++)
		{
	...
	public static void iterateHighLowGet(LinkedList<Integer> a)
	{
	...
	public static void iterateLowHighGet(LinkedList<Integer> a)
	{
	...
	public static void iterateHighLowRemove(LinkedList<Integer> a)
	{
	...
	public static void iterateLowHighRemove(LinkedList<Integer> a)
	{
